...
function onloadServicos() {
    ...
    fetch("https://localhost:7007/api/consulta-servicos", {
        method: "GET",
        headers: {
        ...
        .then(result => {
            ...
            if (result != "Nenhum serviço cadastrado") {
                jsonResponse = JSON.parse(result)
                
                if (Object.keys(jsonResponse).length == 2){
                    var optionElement = document.createElement("option");
                        optionElement.value = jsonResponse.Id;
                        optionElement.textContent = jsonResponse.Id + " - " + jsonResponse.Servico;
        ...
        fetch("https://localhost:7007/api/consulta-servicos", {
            ...
            .then(result => {
                ...
                if (result != "CPF ou CNPJ não encontrado") {
                    jsonResponse2 = JSON.parse(result)
                    resolve(jsonResponse2.nome_razao_social);
...
function pesquisarNomePorCPF_CNPJ(cpf_cnpj) {
    return new Promise(function (resolve, reject) {
        fetch("https://localhost:7007/api/consulta-cliente?cpf_cnpj=" + cpf_cnpj, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
...
function salvarServico() {
    ...
    fetch("https://localhost:7007/api/insere-servicos", {
        method: "Post",
        headers: {
            "Content-Type": "application/json"
        },
